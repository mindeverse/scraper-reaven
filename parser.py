"""Reaven Shopify parser — /en/products.json with EUR cookie."""
...
def fetch_all_products_json() -> list[dict[str, Any]]:
    """Paginate store-wide /en/products.json for full catalog coverage (~88 products)."""
...
def parse_shopify_product(
    ...
    # Reaven has no explicit back images in products.json, so back_image_url stays None
