"""Reaven scraper — scrape Shopify products.json, embed with local SigLIP, upsert Supabase."""
...
logger = logging.Logger("scraper-reaven")
...
def run() -> dict[str, Any]:
    logger.info("=== Reaven scraper start ===")
    ...
    for k, v in summary.items():
        logger.info("%s: %s", k, v)
    logger.info("=== Reaven scraper complete ===")
    return summary
