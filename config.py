...
@dataclass
class Config:
    BRAND_NAME: str = "Reaven"
    SOURCE: str = "scraper-reaven"
    BRAND_COLUMN: str = "Reaven"
    SECOND_HAND: bool = False
    LANDING_PAGE: str = "https://www.reaven.co/en/"
    BASE_URL: str = "https://www.reaven.co/en"
    CURRENCY: str = "EUR"
    COUNTRY: str = "EN"
